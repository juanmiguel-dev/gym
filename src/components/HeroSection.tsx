  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex justify-center">
        {/* Main Lumina Card */}
        <div className="bg-[#050505] rounded-[3rem] border border-white/5 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden relative group w-full max-w-[90vw] md:max-w-[65vw]">
          ...
          <div className="p-10 md:p-24 text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-neon-green/10 border border-neon-green/30 px-4 py-1 rounded-full mb-10 animate-pulse">
              <div className="w-1.6 h-1.5 bg-neon-green rounded-full shadow-[0_0_8px_#39ff14]" />
